...
import com.bhavesh.ragbackend.dto.index.DeleteDocumentRequest;
...
public class IndexingController {
    ...
    public ResponseEntity<Response> deleteDocuments(
            @PathVariable @ValidId String folderId,
            @PathVariable @ValidId String indexId,
            @RequestBody @Valid DeleteDocumentRequest deleteDocumentRequest
            ) {
        indexingService.deleteDocuments(folderId, indexId, deleteDocumentRequest.documentIds());
